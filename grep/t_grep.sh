  ...
  do
      ...
      do
        ...
        then
          ...
          TEST5="-e regex -e ^print s21_grep.c $var $var2 $var3 -f maiamabl_pattern.txt"
          echo "$TEST5"
          ...
          TEST6="-e while -e void s21_grep.c Makefile $var $var2 $var3 -f maiamabl_pattern.txt"
          echo "$TEST6"
